    ...
    private void DisplayLine(Transform repParent) {
        ...
        if (!fast) {
            ...
            for (int i = 0; i < circleSteps; i++) {
                ...
                preCompX[i] = xx * lineWidth * 0.5f;
                preCompY[i] = yy * lineWidth * 0.5f;
            }
                ...
                if (idb != -1) {
                    ...
                    if (fast) {
                        ...
                        for (int i = 0; i < circleSteps; i++) {
                            ...
                            // if (recompute) {
                            //     vertices[idV] = p1;
                            //     normals[idV] = (p1 - start).normalized;
                            // }
                            // else {
                            newVertices.Add(p1);
        ...
        if (!fast) {
            ...
            foreach (UnityMolAtom a in doneAtoms) {
                ...
                for (int v = 0; v < icoSphereVert.Length; v++) {
                    ...
                    // if (recompute) {
                    //     vertices[idV] = ((Vector3)icoSphereVert[v]) * lineWidth * 0.47f + start;
                    //     normals[idV] = icoSphereNorm[v];
                    // }
                    // else {
                    newVertices.Add(((Vector3)icoSphereVert[v]) * lineWidth * 0.47f + start);
    ...
    struct SphereJob : IJobParallelFor
    {
        ...
        void IJobParallelFor.Execute(int index) {
            ...
            for (int v = 0; v < icoSphereVert.Length; v++) {
                ...
                verts[idV] = icoSphereVert[v] * lw * 0.47f + pr.xyz;
